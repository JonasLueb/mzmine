...
./gradlew :mzmine-community:run -x test -x checkLicense -x generateLicenseReport -x copyLicenseInformationToResources -x copyLicenseInformationToBuild --daemon --offline